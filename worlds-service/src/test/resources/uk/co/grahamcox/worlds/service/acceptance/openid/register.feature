Feature: Account Registration
  ...
  Scenario: When I successfully register a new user only asking for an access token
    When I register a new user with parameters:
      | response_type | token                  |
      | scope         | openid                 |
      | client_id     | MyClientId             |
  ...
  Scenario: When I successfully register a new user asking for an access token and ID token
    When I register a new user with parameters:
